...
cd /d D:\Programs\TradingBot\HLBot
...
REM Start the bot
echo Starting HLBot...
start "HLBot" cmd /k ""C:\Users\luc18\AppData\Local\Programs\Python\Python314\python.exe" -m uvicorn src.api.main:create_app --factory --host 0.0.0.0 --port 8000"
